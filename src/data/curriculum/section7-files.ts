    ...
    },
    {
      ...
      challenges: [
        ...
        },
        {
          id: 'fb-7',
          type: 'MULTIPLE_CHOICE',
          instruction: 'What does json.dumps() return?',
          difficulty: 'hard',
          question: 'What does json.dumps(data) return?',
          options: ['A file object', 'A JSON-formatted string', 'A dict', 'A list'],
          correctAnswer: 'A JSON-formatted string',
          explanation: 'json.dumps() serializes a Python object to a JSON string. json.loads() does the reverse.',
        },
        {
          id: 'fb-8',
          type: 'MULTIPLE_CHOICE',
          instruction: 'Best way to process a large file?',
          difficulty: 'hard',
          question: 'What is the most memory-efficient way to process a large file line by line?',
          options: [
            'f.read() then split',
            'f.readlines() then iterate',
            'Iterate directly over the file object: for line in f:',
            'Read the file in binary mode',
          ],
          correctAnswer: 'Iterate directly over the file object: for line in f:',
          explanation: 'Iterating the file object reads one line at a time without loading the whole file into memory.',
        },
        {
          id: 'fb-9',
          type: 'PREDICT_OUTPUT',
          instruction: 'What does json.loads() do?',
          difficulty: 'medium',
