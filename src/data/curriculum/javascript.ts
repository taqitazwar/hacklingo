...
console.log(square(5));",
        ...
        },
        {
          ...
          explanation: 'Both functions return strings. Concatenation produces Hello World.',
          xpReward: 10, difficulty: 'easy',
        },
        {
          id: 'js-func-extra-4',
          ...
          correctAnswer: '20',
          explanation: 'outer() returns inner. outer()() calls inner which returns 10 * 2 = 20.',
    ...
    },
    {
      ...
      challenges: [
        ...
        {
          id: 'js-closure-extra-3',
          type: 'PREDICT_OUTPUT',
          question: "What is logged?",
          codeSnippet: "let counter = 0;\nconst inc = () => ++counter;\nconst dec = () => --counter;\ninc(); inc(); dec();\nconsole.log(counter);",
          correctAnswer: '1',
          explanation: '0+1+1-1 = 1. Both closures share the same counter variable.',
          xpReward: 15, difficulty: 'medium',
        }
      ],
    },
