...
fmt.Println(Pi)",
        ...
        },
        {
          ...
          question: "What does the zero value of a bool in Go default to?",
          options: ['nil', 'true', 'false', '0'],
          correctAnswer: 'false',
    ...
    },
    {
      ...
      challenges: [
        ...
        },,
        {
          id: 'go-test-extra-1',
          type: 'MULTIPLE_CHOICE',
          question: "What is the naming convention for test functions in Go?",
          options: ['test_FunctionName', 'TestFunctionName', 'FunctionNameTest', 'testFunctionName'],
          correctAnswer: 'TestFunctionName',
          explanation: 'Go test functions must start with Test followed by a capitalized name.',
          xpReward: 15, difficulty: 'medium',
        }
      ],
    },
