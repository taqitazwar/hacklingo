...
dog',
        ...
        },
        {
          ...
          options: ['0 to 10', '0, 2, 4, 6, 8', '2, 4, 6, 8, 10', '1, 3, 5, 7, 9'],
          correctAnswer: '0, 2, 4, 6, 8',
          explanation: 'range(start, stop, step) from 0 to 10 stepping by 2, not including 10.',
        ...
        },
        {
          ...
          codeSnippet: "print(sum(range(1, 6)))",
          correctAnswer: '15',
...
print(count)",
    ...
    if user_input == 'q':
        ...
        },
        {
          id: 'cf-while-4',
          type: 'MULTIPLE_CHOICE',
          question: "What keyword exits a while loop immediately?",
...
*****',
        ...
        },
        {
          id: 'cf-boss-5',
          type: 'MULTIPLE_CHOICE',
          question: "What is the else clause in a for loop for?",
          options: ['Runs when loop hits a break', 'Runs when loop completes without break', 'Runs when list is empty', 'Never runs'],
