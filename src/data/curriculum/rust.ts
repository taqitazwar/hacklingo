    ...
    },
    {
      ...
      challenges: [
        ...
        },,
        {
          id: 'rust-err-extra-1',
          type: 'FILL_BLANK',
          question: "Propagate errors with ?",
          codeSnippet: "fn read_file() -> Result<String, io::Error> {\n    let content = fs::read_to_string("file.txt")___?\n    Ok(content)\n}",
          correctAnswer: '',
          explanation: 'The ? operator returns early with Err if the result is Err, otherwise unwraps Ok.',
          xpReward: 20, difficulty: 'hard',
        }
      ],
    },
...
println!("{}", count);',
        ...
        {
          id: 'rust-iter-extra-2',
          type: 'FILL_BLANK',
          question: "Collect iterator into a Vec",
          codeSnippet: "let doubled: Vec<i32> = (1..=5).map(|x| x * 2).___();",
          correctAnswer: 'collect',
          explanation: 'collect() consumes an iterator and collects values into a collection.',
          xpReward: 10, difficulty: 'medium',
        }
      ],
    },
