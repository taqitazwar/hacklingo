...
print(d.get('c', 0))",
        ...
        },
        {
          ...
          options: ['If the value exists', 'If the key exists', 'If the dict is non-empty', 'The index of the key'],
          correctAnswer: 'If the key exists',
...
print(max(d, key=d.get))",
        ...
        },
        {
          ...
          options: ['Deletes the dict', 'Removes all key-value pairs', 'Resets values to None', 'Returns empty dict'],
          correctAnswer: 'Removes all key-value pairs',
          explanation: 'clear() removes all items from the dict in place, leaving it empty.',
          xpReward: 15, difficulty: 'easy',
        }
      ],
    },
    {
      ...
      challenges: [
        ...
        },
        {
          id: 'dict-b-7',
          type: 'PREDICT_OUTPUT',
          instruction: 'What does this dict comprehension produce?',
          difficulty: 'hard',
          code: 'keys = ["a", "b", "c"]\nresult = {k: i for i, k in enumerate(keys)}\nprint(result["b"])',
          options: ['0', '1', '2', 'Error'],
          correctAnswer: '1',
          explanation: 'enumerate gives (0,"a"), (1,"b"), (2,"c"). The dict maps key -> index. result["b"] = 1.',
        },
        {
          id: 'dict-b-8',
          type: 'MULTIPLE_CHOICE',
          instruction: 'defaultdict vs regular dict?',
          difficulty: 'hard',
          question: 'What does collections.defaultdict do?',
          options: [
            'Creates a dict that sorts its keys automatically',
            'Creates a dict that returns a default value for missing keys instead of raising KeyError',
            'Creates a read-only dict',
            'Creates a dict that limits its size',
          ],
          correctAnswer: 'Creates a dict that returns a default value for missing keys instead of raising KeyError',
          explanation: 'defaultdict(int) returns 0 for missing keys. defaultdict(list) returns [] for missing keys.',
        },
        {
          id: 'dict-b-9',
          type: 'PREDICT_OUTPUT',
          instruction: 'Counter output?',
          difficulty: 'hard',
