...
print('World')",
    ...
    print(i, end=' ')",
        ...
        },
        {
          ...
          options: ['Declares a variable', 'Starts a comment', 'Runs a shell command', 'Creates a list'],
          correctAnswer: 'Starts a comment',
          explanation: '# starts a single-line comment. Python ignores everything after # on that line.',
          xpReward: 10, difficulty: 'easy',
        },
        {
          id: 'basics-hello-10',
          ...
          correctAnswer: '1 2 3',
          explanation: '* unpacks the list as separate arguments to print. Default sep is space.',
...
print(0 ___ x ___ 10)",
        ...
        },
        {
          ...
          type: 'PREDICT_OUTPUT',
          question: "What is printed?",
          codeSnippet: "print(bool(0), bool(''), bool([]))",
